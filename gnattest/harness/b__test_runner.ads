...
package ada_main is
   ...
   u00191 : constant Version_32 := 16#f0f87a60#;
   ...
   u00193 : constant Version_32 := 16#284e9c09#;
   pragma Export (C, u00193, "adafitsB");
   u00194 : constant Version_32 := 16#6c60ea3a#;
   pragma Export (C, u00194, "adafitsS");
   u00195 : constant Version_32 := 16#aba6ad12#;
   pragma Export (C, u00195, "interfaces__c__extensionsS");
   u00196 : constant Version_32 := 16#93b6c5e3#;
   pragma Export (C, u00196, "adafits__column_routinesS");
   u00197 : constant Version_32 := 16#32c57b4d#;
   pragma Export (C, u00197, "adafits__generic_column_routinesB");
   u00198 : constant Version_32 := 16#07d9168e#;
   pragma Export (C, u00198, "adafits__generic_column_routinesS");
   u00199 : constant Version_32 := 16#8b004320#;
   pragma Export (C, u00199, "adafits__column_routines__test_dataB");
   u00200 : constant Version_32 := 16#a79d858f#;
   pragma Export (C, u00200, "adafits__column_routines__test_dataS");
   u00201 : constant Version_32 := 16#269b1972#;
   pragma Export (C, u00201, "aunit__test_fixturesB");
   u00202 : constant Version_32 := 16#3b99f1a5#;
   pragma Export (C, u00202, "aunit__test_fixturesS");
   u00203 : constant Version_32 := 16#836f1c33#;
   pragma Export (C, u00203, "adafits__column_routines__test_data__testsB");
   u00204 : constant Version_32 := 16#58ac47be#;
   pragma Export (C, u00204, "adafits__column_routines__test_data__testsS");
   u00205 : constant Version_32 := 16#9777733a#;
   pragma Export (C, u00205, "system__img_lliB");
   u00206 : constant Version_32 := 16#816bc4c0#;
   pragma Export (C, u00206, "system__img_lliS");
   u00207 : constant Version_32 := 16#6d0081c3#;
   pragma Export (C, u00207, "system__img_realB");
   u00208 : constant Version_32 := 16#578cc0f3#;
   pragma Export (C, u00208, "system__img_realS");
   u00209 : constant Version_32 := 16#4f1f4f21#;
   pragma Export (C, u00209, "system__fat_llfS");
   u00210 : constant Version_32 := 16#1b28662b#;
   pragma Export (C, u00210, "system__float_controlB");
   u00211 : constant Version_32 := 16#70d8d22d#;
   pragma Export (C, u00211, "system__float_controlS");
   u00212 : constant Version_32 := 16#06417083#;
   pragma Export (C, u00212, "system__img_lluB");
   u00213 : constant Version_32 := 16#b30ccda4#;
   pragma Export (C, u00213, "system__img_lluS");
   u00214 : constant Version_32 := 16#c054f766#;
   pragma Export (C, u00214, "system__powten_tableS");
   u00215 : constant Version_32 := 16#f6fd0c55#;
   pragma Export (C, u00215, "adafits__column_routines__test_data__tests__suiteB");
   u00216 : constant Version_32 := 16#fc323736#;
   pragma Export (C, u00216, "adafits__column_routines__test_data__tests__suiteS");
   ...
   u00219 : constant Version_32 := 16#21c38df2#;
   pragma Export (C, u00219, "adafits__test_dataB");
   u00220 : constant Version_32 := 16#5df9eeb6#;
   pragma Export (C, u00220, "adafits__test_dataS");
   u00221 : constant Version_32 := 16#115ba683#;
   pragma Export (C, u00221, "adafits__test_data__testsB");
   u00222 : constant Version_32 := 16#2f192d32#;
   pragma Export (C, u00222, "adafits__test_data__testsS");
   u00223 : constant Version_32 := 16#25abebad#;
   pragma Export (C, u00223, "adafits__test_data__tests__suiteB");
   u00224 : constant Version_32 := 16#c0819838#;
   pragma Export (C, u00224, "adafits__test_data__tests__suiteS");
   ...
   --  adafits%s
   --  adafits%b
   --  adafits.generic_column_routines%s
   --  adafits.generic_column_routines%b
   --  adafits.column_routines%s
   --  aunit%s
   --  aunit.memory%s
   --  aunit.memory%b
   --  aunit%b
   ...
   --  adafits.column_routines.test_data%s
   --  adafits.column_routines.test_data%b
   --  adafits.test_data%s
   --  adafits.test_data%b
   --  aunit.test_caller%s
   --  aunit.test_caller%b
   ...
   --  adafits.column_routines.test_data.tests%s
   --  adafits.column_routines.test_data.tests%b
   --  adafits.column_routines.test_data.tests.suite%s
   --  adafits.column_routines.test_data.tests.suite%b
   --  adafits.test_data.tests%s
   --  adafits.test_data.tests%b
   --  adafits.test_data.tests.suite%s
   --  adafits.test_data.tests.suite%b
